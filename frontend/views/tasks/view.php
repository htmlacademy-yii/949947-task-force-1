            ...
            <div class="content-view__header">
                <div class="content-view__headline">
                    ...
                    <span>Размещено в категории
                                    <a href="#" class="link-regular"><?= $task['categories']['name_category']; ?></a>
                                    <?= DateHelper::transferDate($task['dt_add']) ?> назад</span>
                </div>
            ...
            <?php foreach ($replies as $reply) : ?>
                <div class="content-view__feedback-card">
                    <div class="feedback-card__top">
                        <a href="#"><img src="<?= $reply['users']['avatar'] ?>>" width="55" height="55"></a>
                        <div class="feedback-card__top--name">
                            <p><a href="#" class="link-regular"><?= $reply['users']['name_user']; ?></a></p>

                            <?php for ($i = 0; $i < (int)$reply['users']['rating']; $i++): ?>
                                <span></span>
                            <?php endfor; ?>
                            <?php for ($i = 5 - (int)$reply['users']['rating']; $i > 0; $i--): ?>
                                <span class="star-disabled"></span>
                            <?php endfor; ?>

                            <b><?= $reply['users']['rating']; ?></b>
                        </div>
                        <span class="new-task__time">
                            <?= DateHelper::transferDate($reply['dt_add_replies']); ?> назад</span>
                    </div>
        ...
        <div class="profile-mini__wrapper">
            ...
            <div class="profile-mini__top">
                ...
                <div class="profile-mini__name five-stars__rate">
                    <p><?= $customer['name_user'] ?></p>
                </div>
            </div>
            <p class="info-customer"><span>12 заданий</span><span
                    class="last-"><?= DateHelper::transferDate($customer['dt_add_user']) ?> на сайте</span>
            </p>
